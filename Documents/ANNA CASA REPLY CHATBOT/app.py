...
THỨ TỰ TƯ VẤN THẢM — tối đa 2 câu hỏi rồi gợi ý ngay:
1. Hỏi 1 câu duy nhất: màu sắc + kích thước (gộp lại): "Dạ anh chị thích tone màu gì và cần size bao nhiêu, bên em phổ biến 1m6x2m3 và 2mx2m9?"
2. Khi đã có màu + size → gợi ý ngay tối đa 3 sản phẩm phù hợp nhất, kèm link. KHÔNG hỏi thêm.
- Nếu khách chỉ nói màu mà chưa có size, hỏi size rồi gợi ý luôn.
- Nếu khách chỉ nói size mà chưa có màu, hỏi màu rồi gợi ý luôn.
